...
$("#btn-submit").on("click", function (e) {
  ...
  if (!nom) {
    ...
    Swal.fire({
      ...
      html:
        "Souhaitez vous réelement enregistrer la catégorie <b> " +
        nom +
        " </b>?",
      hideOnOverlayClick: false,
      hideOnContentClick: false,
...
$("#btn-update").on("click", function (e) {
  ...
  if (!nom) {
    ...
    Swal.fire({
      title: "Êtes vous sûres?",
      html:
        "Souhaitez vous réelement modifier cette catégorie en : <b> " +
        nom +
        " </b>?",
      hideOnOverlayClick: false,
      hideOnContentClick: false,
...
$("#btn-submit-dep").on("click", function (e) {
  ...
  if (!nom) {
    ...
    Swal.fire({
      title: "Êtes vous sûres?",
      html:
        "Souhaitez vous réelement enregistrer le département <b> " +
        nom +
        " </b>?",
      hideOnOverlayClick: false,
      hideOnContentClick: false,
...
$("#btn-update-dep").on("click", function (e) {
  ...
  if (!nom) {
    ...
    Swal.fire({
      title: "Êtes vous sûres?",
      html:
        "Souhaitez vous réelement modifier ce département en : <b> " +
        nom +
        " </b>?",
      hideOnOverlayClick: false,
      hideOnContentClick: false,
...
$("#btn-add-souscategorie").on("click", function (e) {
  ...
  if (!categorie_id || !departement_id || !nom) {
    ...
    Swal.fire({
      title: "Êtes vous sûres?",
      html:
        "Souhaitez vous réelement enregistrer la sous-catégorie : <b> " +
        nom +
        " </b>?",
      hideOnOverlayClick: false,
      hideOnContentClick: false,
...
function readyUpdateSousCat(id) {
  ...
  $.ajax({
    ...
    $("#update_categorie_id").append(
      "<option selected value=" +
        response.categorie.id +
        ">" +
        response.categorie.nom +
        "</option>"
    );
    $("#update_departement_id").append(
      "<option selected value=" +
...
$("#btn-update-souscategorie").on("click", function (e) {
  ...
  if (!categorie_id || !departement_id || !nom) {
    ...
    Swal.fire({
      title: "Êtes vous sûres?",
      html:
        "Souhaitez vous réelement modifier cette sous-catégorie en : <b> " +
        nom +
        " </b>?",
      hideOnOverlayClick: false,
      hideOnContentClick: false,
